...
aliases:
---
Следующий урок_7: [[Урок_7_Подключение к базе данных]]
# [Условный оператор WHERE](https://sql-academy.org/ru/guide/conditional-where-operator#uslovnyj-operator-where)
...
## [Общая структура запроса с оператором WHERE](https://sql-academy.org/ru/guide/conditional-where-operator#obshaya-struktura-zaprosa-s-operatorom-where)
...
## [Приоритет логических операторов](https://sql-academy.org/ru/guide/conditional-where-operator#prioritet-logicheskih-operatorov)
